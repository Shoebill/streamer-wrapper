...
class PlayerShootDynamicObjectEvent(obj: net.gtaun.shoebill.streamer.data.DynamicObject, val player: net.gtaun.shoebill.`object`.Player, val weaponModel: net.gtaun.shoebill.constant.WeaponModel,
